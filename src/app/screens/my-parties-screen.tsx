...
export function MyPartiesScreen({ parties, onCreate, onEdit, onSelect, onRemoveAttendee }: MyPartiesScreenProps) {
  return (
    <section className="screen with-nav my-parties-screen">
      ...
      {parties.length === 0 ? (
        <EmptyState title="Nenhuma festa sua ainda" text="Crie uma festa para gerenciar confirmados, detalhes e edicao." action="Criar festa" onAction={onCreate} />
      ) : (
