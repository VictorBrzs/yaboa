...
export function PartyDetails({ party, busy, readOnly, onBack, onEdit, onDelete, onCheckIn }: PartyDetailsProps) {
  return (
    <section className="details-screen">
      ...
      <div className="details-content">
        <div className="action-row">
          <button className="primary-button compact" onClick={onCheckIn} disabled={busy || party.isGoing || readOnly}>
            <Check size={18} /> {readOnly ? "Modo convidado" : party.isGoing ? "Presença salva" : "Confirmar presença"}
          </button>
          {party.isOwner && (
